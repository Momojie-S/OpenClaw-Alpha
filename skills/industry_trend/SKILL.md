...
**输出**：
- 控制台：Top 10 景气度排名
- 文件：`.openclaw_alpha/industry_trend/{date}/prosperity.json`

**分析要点**：
- **景气度评分**：综合估值趋势 + 价格趋势 + 市值变化
- **估值趋势**：PE/PB 周环比变化（上升/稳定/下降）
- **景气度等级**：高景气（≥70）、中等景气（50-69）、低景气（<50）
- **黄金三角**：高景气 + 高热度 + 低拥挤度 = 最佳投资机会
...
**景气度评分 = 估值趋势分 × 40% + 价格趋势分 × 40% + 市值变化分 × 20%**

| 维度 | 权重 | 计算方式 |
|------|------|----------|
| 估值趋势 | 40% | PE/PB 周环比变化趋势（上升=100, 稳定=60, 下降=20） |
| 价格趋势 | 40% | 涨跌幅归一化（-10%~+10% 映射到 0-100） |
| 市值变化 | 20% | 市值周环比归一化（-10%~+10% 映射到 0-100） |
...
| 分数 | 等级 | 含义 |
|------|------|------|
| ≥ 70 | 高景气 | 行业基本面强劲，盈利预期好 |
| 50-69 | 中等景气 | 行业稳定发展，中性预期 |
| < 50 | 低景气 | 行业面临压力，谨慎参与 |
