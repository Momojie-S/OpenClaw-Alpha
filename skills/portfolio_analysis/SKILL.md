...
```bash
uv run --env-file .env python skills/portfolio_analysis/scripts/portfolio_processor/__main__.py [参数]
```
...
```bash
# 简单模式（无成本价）
uv run --env-file .env python skills/portfolio_analysis/scripts/portfolio_processor/__main__.py \
