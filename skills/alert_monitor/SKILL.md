...
# 保存报告
uv run --env-file .env python -m skills.alert_monitor.scripts.alert_processor.alert_processor --output

# 输出 JSON 格式
uv run --env-file .env python -m skills.alert_monitor.scripts.alert_processor.alert_processor --json
```
