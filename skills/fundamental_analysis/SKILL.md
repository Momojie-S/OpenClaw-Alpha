...
```bash
# 单只股票基本面分析
uv run --env-file .env python -m openclaw_alpha.skills.fundamental_analysis.fundamental_processor.fundamental_processor --code 000001

# 包含估值历史数据
uv run --env-file .env python -m openclaw_alpha.skills.fundamental_analysis.fundamental_processor.fundamental_processor --code 000001 --include-history
```
