...
```bash
# 查看指定股票的资金流向
uv run --env-file .env python -m openclaw_alpha.skills.stock_fund_flow.stock_fund_flow_processor.stock_fund_flow_processor <股票代码>
...
uv run --env-file .env python -m openclaw_alpha.skills.stock_fund_flow.stock_fund_flow_processor.stock_fund_flow_processor 600519

# 指定汇总周期
uv run --env-file .env python -m openclaw_alpha.skills.stock_fund_flow.stock_fund_flow_processor.stock_fund_flow_processor 000001 --periods 1 5 10

# 指定趋势分析回看天数
uv run --env-file .env python -m openclaw_alpha.skills.stock_fund_flow.stock_fund_flow_processor.stock_fund_flow_processor 000001 --lookback 20

# JSON 输出
uv run --env-file .env python -m openclaw_alpha.skills.stock_fund_flow.stock_fund_flow_processor.stock_fund_flow_processor 000001 --output json
```
