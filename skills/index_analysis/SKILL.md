...
```bash
# 查看今日指数分析
uv run --env-file .env python -m openclaw_alpha.skills.index_analysis.index_processor.index_processor

# 指定日期
uv run --env-file .env python -m openclaw_alpha.skills.index_analysis.index_processor.index_processor --date 2026-03-06

# 只看部分指数
uv run --env-file .env python -m openclaw_alpha.skills.index_analysis.index_processor.index_processor --top-n 3
```
