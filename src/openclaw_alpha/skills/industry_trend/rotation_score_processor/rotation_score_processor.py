...
class RotationScoreProcessor:
    ...
    async def _fetch_and_calc_heat(self) -> dict | None:
        """获取并计算热度数据"""
        from openclaw_alpha.skills.industry_trend.industry_trend_processor.industry_trend_processor import IndustryTrendProcessor
    ...
    async def _fetch_and_calc_crowdedness(self) -> dict | None:
        """获取并计算拥挤度数据"""
        from openclaw_alpha.skills.industry_trend.crowdedness_processor.crowdedness_processor import CrowdednessProcessor
