...
async def scan_northbound_flow(
    ...
    try:
        ...
        from openclaw_alpha.skills.northbound_flow.flow_fetcher import fetch_daily
...
async def scan_industry_trend(
    ...
    try:
        ...
        from openclaw_alpha.skills.industry_trend.industry_trend_processor.industry_trend_processor import (
